...
public class CrawlConfig {
    ...
    /**
     * List of absolute paths to crawler traps files.
    ...
    /**
     * @return the absolute paths to crawler traps files
     */
    public Set<String> getCrawlerTrapsFiles() {
        return crawlerTrapsFiles;
    }

    /**
     * Add a crawler trap file to load.
     * @param absolutePath
     * @throws IOException if the file does not exist or is not readable.
     */
    public void addCrawlerTrapFile(String absolutePath) throws IOException {
        File f = new File(absolutePath);
        if (!f.exists() || !f.isFile() || !f.canRead()) {
            throw new IOException("Can't acces crawler trap file " + absolutePath);
        }
